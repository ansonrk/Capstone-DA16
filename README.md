...
This project will merge several datasets and present findings through modern, user‑friendly visualizations.


• Organ Procurement and Transplantation Network (OPTN)
https://www.hrsa.gov/optn/data/data-reports
• United Network for Organ Sharing (UNOS) public datasets
https://unos.org/data/
• CDC public health and mortality datasets
https://wonder.cdc.gov/
• U.S. Census Bureau for demographic and socioeconomic context
